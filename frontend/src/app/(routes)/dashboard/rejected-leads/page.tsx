...
import { ChevronRight, Search, Users, Phone, MapPin, Calendar, Eye, User, XCircle } from "lucide-react"
...
const RejectedLeadsPage = () => {
  ...
  const sendToLeadDetail = async (leadId: string) => {
    router.push(`/dashboard/rejected-leads/${leadId}`);
  }
  ...
  return (
    <>
      <Head>
        <title>Rejected Leads | Open Leads</title>
        <meta
          name="description"
          content="View and analyze all rejected leads in your pipeline. Open Leads helps you track dropped opportunities with complete lead details and visit logs."
        />
        <meta
          name="keywords"
          content="rejected leads, dropped leads, lost opportunities, CRM lead status, Open Leads CRM, lead tracking, sales funnel"
        />

        {/* Open Graph Meta */}
        <meta property="og:title" content="Rejected Leads | Open Leads" />
        <meta
          property="og:description"
          content="Explore and review all leads marked as rejected. Understand why they dropped off and access their full history."
        />
        <meta property="og:url" content="https://www.openleads.in/dashboard/rejected-leads" />
        <meta property="og:site_name" content="Open Leads" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.openleads.in/og-image-rejected.png" />
        <meta property="og:image:alt" content="Rejected Leads Dashboard - Open Leads" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        {/* Twitter Meta */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Rejected Leads | Open Leads" />
        <meta
          name="twitter:description"
          content="Track all rejected leads in one place. Access contact info, search area, notes, and rejection dates through the Open Leads dashboard."
        />
        <meta name="twitter:image" content="https://www.openleads.in/og-image-rejected.png" />
      </Head>
          ...
          <div className="mb-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-2">Rejected Leads</h1>
                  <p className="text-slate-600 dark:text-slate-300">
                    Review leads that were not converted and their details
                  </p>
                </div>
              ...
              <div className="pb-4 border-b border-slate-200 dark:border-slate-700 mb-6">
                <h3 className="text-xl font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                  ...
                  {!isLoading && allLeads.length > 0 && (
                    <span className="ml-2 px-2 py-1 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 text-xs font-medium rounded-full">
                      {filteredLeads.length} of {allLeads.length}
                    </span>
                  )}
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-sm mt-1">
                  Leads that were marked as rejected and their details
                </p>
              </div>
                  ...
                  {filteredLeads.length > 0 ? (
                              ...
                              >
                                ...
                                <td className="py-4 px-2">
                                  <div className="text-slate-600 dark:text-slate-300">
                                    {lead?.rejectedAt ? formatDate(lead.rejectedAt) : "N/A"}
                                  </div>
                                </td>
                                <td className="py-4 px-2">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-slate-600 dark:text-slate-300">
                                  Rejected On: {lead?.rejectedAt ? formatDate(lead.rejectedAt) : "N/A"}
                                </span>
                              </div>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                        No rejected leads match your search criteria. Try adjusting your search terms.
                      </p>
                    </div>
                  ) : (
                    <div className="text-center py-12">
                      ...
                      <h4 className="text-lg font-medium text-slate-900 dark:text-white mb-2">No rejected leads yet</h4>
                      <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6">
                        You haven't rejected any leads yet. Leads marked as rejected will appear here.
                      </p>
                      <Link

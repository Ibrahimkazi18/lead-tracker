...
const AddReferralAgentPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Add Referral Agents | Open Leads</title>
        <meta
          name="description"
          content="Search and add new referral agents to your Open Leads network to expand your real estate team and boost conversions."
        />
        <meta
          name="keywords"
          content="add referral agent, open leads, real estate network, referral system, agent CRM, manage real estate agents, agent network growth, real estate lead system, referral management"
        />

        {/* Open Graph Meta */}
        <meta property="og:title" content="Add Referral Agents | Open Leads" />
        <meta
          property="og:description"
          content="Search and connect with real estate agents to grow your referral network on Open Leads."
        />
        <meta property="og:url" content="https://www.openleads.in/add-agent" />
        <meta property="og:site_name" content="Open Leads" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.openleads.in/og-image-add-agent.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Add Referral Agents on Open Leads" />

        {/* Twitter Card Meta */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Add Referral Agents | Open Leads" />
        <meta
          name="twitter:description"
          content="Easily find and add referral agents to your Open Leads account for seamless collaboration."
        />
        <meta name="twitter:image" content="https://www.openleads.in/og-image-add-agent.png" />
      </Head>

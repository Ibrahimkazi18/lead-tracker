...
const SettingsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Settings | Open Leads</title>
        <meta
          name="description"
          content="Manage your Open Leads account settings. Update your password, configure lead expiry duration, or delete your account with full control."
        />
        <meta
          name="keywords"
          content="CRM settings, agent profile, change password, lead expiry, delete account, Open Leads preferences"
        />

        {/* Open Graph Meta */}
        <meta property="og:title" content="Settings | Open Leads" />
        <meta
          property="og:description"
          content="Control your CRM preferences. Change password, manage lead expiry time, and securely delete your account."
        />
        <meta property="og:url" content="https://www.openleads.in/dashboard/settings" />
        <meta property="og:site_name" content="Open Leads" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.openleads.in/og-image-settings.png" />
        <meta property="og:image:alt" content="Agent Settings Panel - Open Leads" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        {/* Twitter Meta */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Settings | Open Leads" />
        <meta
          name="twitter:description"
          content="Adjust your Open Leads preferences. Update password, lead expiry days, or delete account securely."
        />
        <meta name="twitter:image" content="https://www.openleads.in/og-image-settings.png" />
      </Head>

...
const AllReferralAgentPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Your Referral Agents | Open Leads</title>
        <meta
          name="description"
          content="View and manage your network of referral agents on Open Leads. Remove agents or expand your network easily."
        />
        <meta
          name="keywords"
          content="referral agents, manage agents, Open Leads, agent dashboard, real estate network, agent CRM, remove referral agents, real estate software, agent list management, real estate lead tracker"
        />

        {/* Open Graph */}
        <meta property="og:title" content="Your Referral Agents | Open Leads" />
        <meta
          property="og:description"
          content="Easily view and manage your referral agents in one place with Open Leads."
        />
        <meta property="og:url" content="https://www.openleads.in/dashboard/referral-agents" />
        <meta property="og:site_name" content="Open Leads" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.openleads.in/og-image-referral-list.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Referral Agents Overview | Open Leads" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Your Referral Agents | Open Leads" />
        <meta
          name="twitter:description"
          content="Manage your entire network of referral agents from one dashboard."
        />
        <meta name="twitter:image" content="https://www.openleads.in/og-image-referral-list.png" />
      </Head>
